...
<head>
    ...
    <title>Register as Institution - Academic Exchange Platform</title>
        ...
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body">
                        <h2 class="card-title text-center mb-4">Institution Registration</h2>
                        <form action="register" method="post">
                            <input type="hidden" name="userType" value="institution">
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" placeholder="Registration Email" required>
                            </div>
                            <div class="form-group">
